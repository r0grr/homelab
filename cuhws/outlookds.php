...
@media screen and (max-width: 768px) {
    ...
    .weather34darkbrowser { width: 100% !important; margin-left: 0 !important; }
    .weather34darkbrowser[url]:after { font-size: 11px !important; margin-left: 50px !important; margin-right: 10px !important; }
    .darkskydiv { width: 100% !important; height: auto !important; display: flex !important; flex-wrap: wrap !important; justify-content: center !important; margin-left: 0 !important; }
    .darkskyforecastinghome { width: 45% !important; min-width: 130px !important; margin: 4px !important; }
}
</style>
</head>
<body>
<div class="weather34darkbrowser" url="DarkSky <?php echo $lang['Forecast'];?> (<?php echo $weather["temp_units"]?>&deg;)"></div>
		<div style="position:relative;width:100%;max-width:725px;background:none;margin:0 auto;padding:0 5px;box-sizing:border-box;">
