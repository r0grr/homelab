...
$wind_max_speed = isset($weather["wind_speed_max"]) ? floatval($weather["wind_speed_max"]) : 0.0;
$maxwindtime = isset($weather["maxwindtime"]) ? $weather["maxwindtime"] : '';
$maxgusttime = isset($weather["maxgusttime"]) ? $weather["maxgusttime"] : '';
